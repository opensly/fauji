...
var require_is_empty_dir = __commonJS({
  "node_modules/is-empty-dir/index.js"(exports2, module2) {
    ...
    module2.exports = isEmptyDir;
    module2.exports.isEmptyDir = isEmptyDir;
    module2.exports.isEmptyDirSync = isEmptyDirSync;
    module2.exports.default = isEmptyDir;
  }
});

// src/run-assertions/test-discovery.js
var require_test_discovery = __commonJS({
  "src/run-assertions/test-discovery.js"(exports2, module2) {
    var fs = require("fs").promises;
    var path = require("path");
    var isEmptyDir = require_is_empty_dir();
...
var require_test_execution = __commonJS({
  "src/run-assertions/test-execution.js"(exports2, module2) {
...
var require_cache = __commonJS({
  "src/run-assertions/cache.js"(exports2, module2) {
    var fs = require("fs").promises;
    var path = require("path");
    var CACHE_FILE = path.join(process.cwd(), ".fauji-cache.json");
    ...
    module2.exports = { loadCache, saveCache };
  }
});

// src/run-assertions/env-setup.js
var require_env_setup = __commonJS({
  "src/run-assertions/env-setup.js"(exports2, module2) {
    ...
    module2.exports = { setupJsdomIfNeeded };
  }
});
...
var require_runner = __commonJS({
  "src/run-assertions/runner.js"() {
    var { findTestFiles } = require_test_discovery();
    var { runTestFiles } = require_test_execution();
    var { loadCache, saveCache } = require_cache();
    var { setupJsdomIfNeeded } = require_env_setup();
  }
});
...
var require_utils = __commonJS({
  "src/matchers/utils.js"(exports2, module2) {
    var util = require("util");
    var deepEqual = require_cjs();
...
var require_equality = __commonJS({
  "src/matchers/equality.js"(exports2, module2) {
    var { getMatcherResult } = require_utils();
    var deepEqual = require_cjs();
    module2.exports = {
...
var require_type = __commonJS({
  "src/matchers/type.js"(exports2, module2) {
    var { getMatcherResult, isArray, isObject, isString, isNumber, isBoolean, isFunction, isDate, isRegExp } = require_utils();
    module2.exports = {
...
var require_string2 = __commonJS({
  "src/matchers/string.js"(exports2, module2) {
    var { getMatcherResult } = require_utils();
    module2.exports = {
...
var require_object = __commonJS({
  "src/matchers/object.js"(exports2, module2) {
    var { getMatcherResult, isMatch, hasByPath, getByPath, deepEqual } = require_utils();
    module2.exports = {
...
var require_number = __commonJS({
  "src/matchers/number.js"(exports2, module2) {
    var { getMatcherResult, isNumber } = require_utils();
    module2.exports = {
...
var require_spy = __commonJS({
  "src/matchers/spy.js"(exports2, module2) {
    ...
    var _mockedModules = /* @__PURE__ */ new Map();
    var _originalModules = /* @__PURE__ */ new Map();
    function fn(impl) {
    ...
    function autoMockExports(exports3) {
      const mocked = {};
      for (const key of Object.keys(exports3)) {
        if (typeof exports3[key] === "function") {
          mocked[key] = fn();
        } else {
          mocked[key] = exports3[key];
        }
      }
      return mocked;
    }
...
var require_spyMatchers = __commonJS({
  "src/matchers/spyMatchers.js"(exports2, module2) {
    var { getMatcherResult, deepEqual } = require_utils();
    var { isSpy } = require_spy();
    module2.exports = {
...
var require_async = __commonJS({
  "src/matchers/async.js"(exports2, module2) {
    var { getMatcherResult } = require_utils();
    module2.exports = {
...
var require_schema = __commonJS({
  "src/matchers/schema.js"(exports2, module2) {
    var { getMatcherResult, matchSchema } = require_utils();
    module2.exports = {
...
var require_empty = __commonJS({
  "src/matchers/empty.js"(exports2, module2) {
    var { getMatcherResult, isEmpty } = require_utils();
    module2.exports = {
...
var require_validation = __commonJS({
  "src/matchers/validation.js"(exports2, module2) {
    var { getMatcherResult, isValidJSON, isValidURL, isValidEmail, isValidUUID } = require_utils();
    module2.exports = {
...
var require_satisfy = __commonJS({
  "src/matchers/satisfy.js"(exports2, module2) {
    var { getMatcherResult } = require_utils();
    module2.exports = {
...
var require_throw = __commonJS({
  "src/matchers/throw.js"(exports2, module2) {
    var { getMatcherResult } = require_utils();
    module2.exports = {
...
var require_length = __commonJS({
  "src/matchers/length.js"(exports2, module2) {
    var { getMatcherResult } = require_utils();
    module2.exports = {
...
var require_matchers = __commonJS({
  "src/matchers/index.js"(exports2, module2) {
    var equality = require_equality();
    var type = require_type();
    var string = require_string2();
    var object = require_object();
    var number = require_number();
    var spyMatchers = require_spyMatchers();
    var asyncMatchers = require_async();
    var schema = require_schema();
    var empty = require_empty();
    var validation = require_validation();
    var satisfy = require_satisfy();
    var throwMatcher = require_throw();
...
module.exports = {
  ...
  spy: require_spy().spy,
  stub: require_spy().stub,
  mock: require_spy().mock
};
